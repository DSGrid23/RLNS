...
def parse_args():
    parser = argparse.ArgumentParser(description="RLNS")

    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="ml100k",
                        help="Choose a dataset:[amazon,ml100k,ali]")
    parser.add_argument(
    ...
    parser.add_argument("--rl_weight", type=float, default=1e-2,
                        help="weight λ for RL losses (policy + critic)")
    parser.add_argument("--rl_heads", type=int, default=2,
                        help="number of heads for RL")
    parser.add_argument("--entropy_coef", type=float, default=0.01,
                        help="entropy regularization weight for actor")
    parser.add_argument("--value_coef", type=float, default=0.01,
                        help="value regularization weight for critic")
    parser.add_argument("--rl_hidden", type=int, default=64,
                        help="hidden size of RL")
    parser.add_argument("--rl_dropout", type=float, default=0.1,
                        help="dropout rate for RL")
